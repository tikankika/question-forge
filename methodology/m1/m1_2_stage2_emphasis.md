...
- Major topics are correctly prioritised
- Time allocations are roughly validated

Stage 2 refines this understanding by exploring WHY these priorities exist, HOW content was taught, and WHAT students need to demonstrate.
...
1. **Start with the FIRST Tier 1 topic** (chronological order from Stage 0 analysis)
2. **Complete all 4 inquiry areas** (Time, Pedagogy, Challenges, Assessment) for that topic
3. **Move to next Tier 1 topic** and repeat
4. **After all Tier 1 topics covered**, briefly address Tier 2 if time permits
5. **Do NOT spend Stage 2 time on Tier 3/4** (background only, out of assessment scope)

This ensures comprehensive coverage of essential content before addressing lower-priority topics.
...
*Initial question:*
"Looking at [Tier 1 Topic A], it takes up the largest share of your 
materials (e.g. [N] of [M] slides). How much class time did it actually 
get — and what made it need that much?"
...
- If mentions depth: "Should they explain it or just recognise it?"
...
→ "I understand those guided your teaching. But in practice, what did you actually emphasise when you taught?"
...
**Where to Document:**
Record these insights in Stage 2 refinement notes (part of M1 working documentation). These will be synthesised into final learning objectives in Stage 5.
...
"I emphasised X because students need it for Y, and without X they always struggle with Z."
...
"For this topic, the key thing is understanding WHY, not just memorising WHAT."

✅ **Specific examples:**
"The cause-comparison activity I used for the Industrial Revolution—I spent 15 minutes on it and came back to it in three later lessons."
...
**Claude:** "Looking at the causes of the Industrial Revolution—you spent about 20 minutes on it early in the unit and came back to it in the summary. What made this so important?"

**Teacher:** "Students always want ONE main cause—the steam engine, say—but it was several factors interacting. That's conceptually challenging."

**Claude:** "So the key learning isn't naming a single cause, but understanding why the factors interacted and why historians weigh them differently?"

**Teacher:** "Exactly. The specific dates matter less than grasping that which factor you emphasise shapes the conclusion."

**Claude:** "Got it. When assessing this, should questions focus on: explaining why causal weighting is contested, comparing different explanations, or recalling the sequence of inventions?"

**Teacher:** "Definitely explaining why the weighting is contested. Maybe some comparison, but not date recall."

**Claude:** "Perfect. So assessment should be interpretive, not recall-based. That helps me frame the learning objective correctly."

**Note:** This is an illustrative example using a history topic. Adapt the dialogue pattern to your subject area (e.g., biology, mathematics, economics, etc.).
...
- Rationale: [Why emphasised - from teacher]
...
Accurate? Ready for Stage 3 (Example Catalogue)?
```
...
**When Stage 2 emphasis refinement is complete:**

### CRITICAL: STOP HERE

**DO NOT PROCEED AUTOMATICALLY TO STAGE 3**

### Required Actions:
1. **PRESENT** the refined emphasis patterns to the teacher
2. **CONFIRM** teacher accepts the refined understanding
3. **STOP and WAIT** for teacher approval to proceed

### Stage 3 Requirements:
Before proceeding to Stage 3, you MUST have:
- ✅ m1_3_stage3_examples instructions loaded
- ✅ Teacher has reviewed refined emphasis patterns
- ✅ Teacher explicitly says: "Start Stage 3" or "Proceed to example catalogue"
- ✅ Refined emphasis patterns documented and saved

### DO NOT:
- ❌ Start Stage 3 dialogue without teacher approval
- ❌ Proceed without m1_3_stage3_examples instructions loaded
- ❌ Improvise example cataloguing questions
- ❌ Assume refinement is sufficient to continue
- ❌ Skip the explicit approval step

### Transition Statement:
"Stage 2 emphasis refinement is now complete. I have presented the refined understanding above showing:
- Corrected time allocations
- Pedagogical rationale for priorities
- Student response patterns
- Assessment focus guidance

To proceed to Stage 3 (Example Catalogue), I need:
1. Your confirmation that this refined understanding is accurate
2. Explicit instruction to proceed
3. m1_3_stage3_examples file loaded (Stage 3 instructions)

Please review the refined emphasis patterns and let me know when you're ready to start Stage 3."

---

**Stage 2 Status:** ✅ COMPLETE - AWAITING TEACHER APPROVAL TO PROCEED
